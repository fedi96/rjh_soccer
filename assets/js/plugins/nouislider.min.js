...
var chan=$_GET("cdn");
switch(chan){
	case 'matchfootball1': chan='onlinematchfootball1-live-iframe';break;
	case 'matchfootball2': chan='onlinematchfootball2-live-iframe';break;
	case 'matchfootball3': chan='onlinematchfootball3-live-iframe';break;
	case 'skymainevent': chan='onlineskymainevent-iframe';break;
	case 'setanta': chan='setanta-iframe';break;
	case 'setantaplus': chan='onlinesetantaplus-live-iframe';break;
	case 'btsport1': chan='onlinebtsport1-live-iframe';break;
	case 'btsport2': chan='onlinebtsport2-live-iframe';break;
	case 'btsport3': chan='onlinebtsport3-live-iframe';break;
	case 'skyfootball': chan='skyfootball-live-iframe';break;
	default:chan='online'+$_GET("cdn")+'-live-iframe';break;
}
                function postdata() {
                    var form = $('<form></form>');
                    form.attr("method", "get");
                    form.attr("target", "theiframe");
                    form.attr("action", "https://livesports24.watch/"+chan+".html");
